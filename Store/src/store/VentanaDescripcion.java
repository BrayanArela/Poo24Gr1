...
public class VentanaDescripcion extends javax.swing.JFrame {
    ...
    public void cantidades(String cantidad1, String cantidad2, String cantidad3, String cantidad4){
        ...
        //precios
        txtPrecioSinIVA1.setText("$42");
        txtPrecioSinIVA2.setText("$18.42");
        txtPrecioSinIVA3.setText("$12.6");
        txtPrecioSinIVA4.setText("$18.9");
        //precios + iva
        float p1 = 42.0f + (42.0f*0.16f);
        float p2 = 18.42f + (18.42f*0.16f);
        float p3 = 12.6f + (12.6f*0.16f);
        float p4 = 18.9f + (18.9f*0.16f);
